...
public class SpawnToletPapir : MonoBehaviour
{
    public GameObject PaketToletPapira;
    ...
    void Update()
    {
        if (spawnSec < 0)
        {
            ...
            Instantiate(PaketToletPapira, spawnPoints[rand].position, spawnPoints[rand].rotation);
